import { U as UnsupportedFunctionalityError, N as NoSuchModelError, h as TooManyEmbeddingValuesForCallError } from "./ai-sdk__provider.mjs";
import { w as withoutTrailingSlash, H as generateId, M as parseProviderOptions, N as injectJsonInstructionIntoMessages, p as postJsonToApi, b as combineHeaders, d as withUserAgentSuffix, O as loadApiKey, a as createJsonResponseHandler, h as createEventSourceResponseHandler, P as convertToBase64, c as createJsonErrorResponseHandler } from "./ai-sdk__provider-utils.mjs";
import { o as object, _ as _enum, f as boolean, n as number, b as string, l as literal, e as union, c as array, d as discriminatedUnion } from "./zod.mjs";
...
var mistralLanguageModelOptions = object({
   ...
   */
  reasoningEffort: _enum(["high", "none"]).optional()
});
...
var mistralUsageSchema = object({
  ...
  total_tokens: number(),
  num_cached_tokens: number().nullish(),
  prompt_tokens_details: object({ cached_tokens: number().nullish() }).nullish(),
  prompt_token_details: object({ cached_tokens: number().nullish() }).nullish()
});
