...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B8vyxCDI.mjs");
...
const manifest = {
  "076f0d27c3d7b1fba7365afd1647231a0b13d6f0dd851a947be0c6d6c54fdc74": {
    functionName: "createDocument_createServerFn_handler",
    importer: () => import("./documents.functions-DZJUmMn_.mjs")
  },
  "0b6eaaf0affa05d8406d489ac99eda00e3421778cab940e69680df0823f93f94": {
    functionName: "deleteJob_createServerFn_handler",
    importer: () => import("./jobs.functions-BnjP5I5H.mjs")
  },
  "0f48f63a16bd9a3856b3e79fbdc4867b20aaa2fb8c6db0c89be1c1971f16e886": {
    functionName: "ingestJobFromUrl_createServerFn_handler",
    importer: () => import("./jobs.functions-BnjP5I5H.mjs")
  },
  ...
  "1697f68c362f0f7295091ed4dfd426e28abdf8975e9ae613689d562bea4cd6c8": {
  ...
  "1e9e3b335f696f04224ab187fa3131a6d38970d9a29a8de98e16b829548176a3": {
    ...
    importer: () => import("./applications.functions-DmkOENUL.mjs")
  },
  "219c7d168b9edf21559b9f8e09fd26118970dedcf6b2b018d00a5896d272f461": {
    functionName: "resetWorkspace_createServerFn_handler",
    importer: () => import("./reset.functions-CeZVrQ7N.mjs")
  },
  "23b688b44de4177df4b9f4716c410814ed4d5b5b5dad74361c8742c1087bf984": {
    functionName: "updateApplicationContent_createServerFn_handler",
    importer: () => import("./applications.functions-DmkOENUL.mjs")
  },
  "2bedff7eed0be97e66af26963ae224726d54d4a347dd9ef45cd5e6ef0d1d080a": {
    functionName: "tailorResume_createServerFn_handler",
    importer: () => import("./tailoring.functions-BqlayYpL.mjs")
  },
  "393606eba184695eb40436bbb807614c9b6a75144b3c631e359a10cd1740f944": {
    functionName: "refineDraft_createServerFn_handler",
    importer: () => import("./refine.functions-08MiFwN4.mjs")
  },
  "3aa19b2f79082c5ff1f5628e9f17c9b708bb5ffaa61831d8c1a2062fe799a8a2": {
    functionName: "deleteDocument_createServerFn_handler",
    importer: () => import("./documents.functions-DZJUmMn_.mjs")
  },
  "3e581435ed25a770e4e5fa2c3e68f08aad53ec3e29b97af82f7e372ee23e71c8": {
    functionName: "saveSkillsAndCerts_createServerFn_handler",
    importer: () => import("./user-understanding.functions-a7sJWOI7.mjs")
  },
  "3ef7d8336e9731f3be3b89a712f7bd259c8a3f5c9a31a861788ee07efde7c522": {
    functionName: "listReviewQueue_createServerFn_handler",
    importer: () => import("./applications.functions-DmkOENUL.mjs")
  },
  "40d7cd55085c4973af863a47ae050ad4a2716c1f242b685dd258cd60ef721dd4": {
    functionName: "nextUnderstandingQuestion_createServerFn_handler",
    importer: () => import("./user-understanding.functions-a7sJWOI7.mjs")
  },
  ...
  "4b0245ea64aa59557a509a17c883ce6db228d217d2e0976abb229b07105beabd": {
    functionName: "runApplyPipeline_createServerFn_handler",
    importer: () => import("./orchestration.functions-B-AhdO0s.mjs")
  },
  "4c2e06485dea779ce3392ef39142f51566adab607c04c658cec264cee3ea1600": {
    functionName: "cancelAutomation_createServerFn_handler",
    importer: () => import("./automation.functions-CYy9uk7C.mjs")
  },
  "4d5cf242359c128d3e6be9c2ef541689853138323c62cc268fef541c202ac144": {
    functionName: "behavioralDrills_createServerFn_handler",
    importer: () => import("./behavioral.functions-Bi3a_Oas.mjs")
  },
  "509d86f3d83fdc12ec47488edc7eb1bb9dd98b7b5fb119bae813b55291605308": {
    functionName: "draftAutomationPlan_createServerFn_handler",
    importer: () => import("./automation.functions-CYy9uk7C.mjs")
  },
  "5338d6b9abfa7a069fd74e45d68179783053f7a1c3e900169a6e1492876aaf6c": {
    functionName: "analyzeWritingStyle_createServerFn_handler",
    importer: () => import("./style.functions-E5xiHLf3.mjs")
  },
  "5dbf46616266e7bfe81c82694a91090a42de6200b3efc1b9d156faf41ac3a479": {
    functionName: "getMyProfile_createServerFn_handler",
    importer: () => import("./profile.functions-CZJ1dlX4.mjs")
  },
  "7bbe916d0c0b14b33e289192f7ab12893c0b8286759f1948b274b5c959369258": {
    functionName: "listDocuments_createServerFn_handler",
    importer: () => import("./documents.functions-DZJUmMn_.mjs")
  },
  "811332b57d5b8a07c9b10f493bec8b16d51c3020dff36e88983be63a9b8d795d": {
    functionName: "reviewApplicationDraft_createServerFn_handler",
    importer: () => import("./reviewer.functions-DNZbazHZ.mjs")
  },
  "8176261e07e3ac98995faae6ec3144ffb8b6e40cdef22e8e651ab0c3c453d8df": {
    functionName: "getApplicationForJob_createServerFn_handler",
    importer: () => import("./applications.functions-DmkOENUL.mjs")
  },
  "82af261b5992109314eb96680e7a19b247ce284134c511d57226d5b6c94ecee9": {
    functionName: "prepInterview_createServerFn_handler",
    importer: () => import("./interview.functions-DX0uJ0to.mjs")
  },
  "830957613f44908f187c8f6dfab3ee897f532826ac1ea82889f3ad23f34fac4b": {
    functionName: "importProfile_createServerFn_handler",
    importer: () => import("./profile-import.functions-BlnUzyM4.mjs")
  },
  "88162fc58b21076679b4afdbca516bf6dae8c11f6a28b1489b1df3e51c5e574b": {
    functionName: "rankJob_createServerFn_handler",
    importer: () => import("./ranking.functions-RDdLp-mT.mjs")
  },
  "88a23fd8ea2ce93d18ebdd701a87d4c4decf7b18fd0d26aee8ab06e06474b5f1": {
    functionName: "searchJobsWeb_createServerFn_handler",
    importer: () => import("./jobsearch.functions-Cpi9JhwG.mjs")
  },
  ...
  "8eeb7b9d8c0eae6b88e01fad3d05a5cc8b2c57ddd4ac41e3e3d7510463e66e3b": {
    functionName: "getApplication_createServerFn_handler",
    importer: () => import("./applications.functions-DmkOENUL.mjs")
  },
  "925d6f20f4116bb43fc05bdd97894c4b9fc40c4021d2ff8ca736aeef71f639a7": {
    functionName: "decideReview_createServerFn_handler",
    importer: () => import("./applications.functions-DmkOENUL.mjs")
  },
  "9e23ea56720f0d68b8abba550b4704d12b4392ba344e9f7b1518c5dcbb091e90": {
    functionName: "discoverCareerPaths_createServerFn_handler",
    importer: () => import("./career.functions-CcOjupd_.mjs")
  },
  "9e256d631e8cea9a27f8fa10731bb32fc04277b0f8c4de8450b160a1dd3221a5": {
    functionName: "saveUnderstanding_createServerFn_handler",
    importer: () => import("./user-understanding.functions-a7sJWOI7.mjs")
  },
  ...
  "b2eafea1a293ffbe23e02070d4ffdea7a746809aeeb74d3b7978189b4f5844f6": {
    functionName: "confirmSubmission_createServerFn_handler",
    importer: () => import("./automation.functions-CYy9uk7C.mjs")
  },
  "b747631a2578ddab2e0b51768b36dfc717c0fb527a2936a31201899f240b0ecb": {
    functionName: "downloadDocument_createServerFn_handler",
    importer: () => import("./documents.functions-DZJUmMn_.mjs")
  },
  "c32e556bbcd544a5672e7210ea6de6da53c48087e7a3bc7eaaf7f8939506dd45": {
    functionName: "clearWritingStyle_createServerFn_handler",
    importer: () => import("./style.functions-E5xiHLf3.mjs")
  },
  "c6e89d59aafd294c313310bcdf31cc5e019b5fe6d7feabe6aec847a73718a2a2": {
    functionName: "rankAllJobs_createServerFn_handler",
    importer: () => import("./ranking.functions-RDdLp-mT.mjs")
  },
  "d19a487eddacfbec7f4c8538f89eab324875a5c6f0d23e74f9cb61206c545bce": {
    functionName: "generateAnswer_createServerFn_handler",
    importer: () => import("./tailoring.functions-BqlayYpL.mjs")
  },
  "d6f1ff7a9c62b7e29465d826fd20e715cc05210149163e23115112b4ec60bd68": {
    functionName: "upskillPlan_createServerFn_handler",
    importer: () => import("./upskill.functions-DX44KytH.mjs")
  },
  "dd290c8647d12012d1fbf65822ceb90717b2367355b4abc18b06013d749afc22": {
    functionName: "applyToTopJobs_createServerFn_handler",
    importer: () => import("./orchestration.functions-B-AhdO0s.mjs")
  },
  "f1f540e1de87c3de8204f4f3fc4452e8eb4b1f18ea8e754ca50c092b9330d216": {
    functionName: "generateCoverLetter_createServerFn_handler",
    importer: () => import("./tailoring.functions-BqlayYpL.mjs")
  },
  "f9e29a34087db992df181049503dcac8fd3c6cdc6c2285fa73657c0a51ef0011": {
    functionName: "expandProfile_createServerFn_handler",
    importer: () => import("./expand.functions-O2XPl_fZ.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ClvJc2re.mjs").then((n) => n.r),
    import("./start-C5vcen7E.mjs"),
