    ...
    handlers: {
      ...
      POST: async ({ request }) => {
        ...
        const normalizedProfile = {
          ...
          work_authorization: profile?.work_authorization ?? "US Citizen / Permanent Resident",
          requires_sponsorship: profile?.requires_sponsorship ? "yes" : "no",
          salary_expectations: (profile as Record<string, unknown>)?.target_salary ? String((profile as Record<string, unknown>).target_salary) : "Competitive / Open to discussion",
