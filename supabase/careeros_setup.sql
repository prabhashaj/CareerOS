-- ===========================================================================
-- CareerOS — Full Database Setup Script
...
CREATE TABLE public.jobs (
  ...
  -- Mistral embed = 1024 dims (was 1536 with OpenAI)
...
-- Note: vector(1024) for Mistral embed (was 1536 for OpenAI)
-- =========================================================
...
-- =========================================================
-- STORAGE BUCKET
-- Create the 'jobpilot-documents' bucket manually in:
-- Supabase Dashboard → Storage → New bucket
-- Name: jobpilot-documents, Public: OFF
-- =========================================================
...
-- =========================================================
-- RESUME VERSIONS (Snapshots / Checkpoints)
-- =========================================================
